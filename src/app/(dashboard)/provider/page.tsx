    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex-1">
        ...
        <div className="relative mb-6">
          ...
          <input
            type="text"
            className="text-gray-900 w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2f6f1f]/20 focus:border-[#2f6f1f] transition-all"
